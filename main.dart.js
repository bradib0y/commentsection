...
(function dartProgram() {
  ...
  F = {
    main: function() {
      var t1,
        mySubmit = H.interceptedTypeCheck(document.querySelector("#mySubmit"), "$isButtonElement");
      mySubmit.toString;
      t1 = W.MouseEvent;
      W._EventStreamSubscription$(mySubmit, "click", H.functionTypeCheck(F.main__onInputSubmit$closure(), {func: 1, ret: -1, args: [t1]}), false, t1);
    },
    onInputSubmit: function($event) {
      var t1, myInput, t2, now, newCommentElement, myCommentDivElement;
      H.interceptedTypeCheck($event, "$isMouseEvent");
      t1 = document;
      myInput = H.interceptedTypeCheck(t1.querySelector("#myInput"), "$isInputElement");
      t2 = myInput.value;
      now = new P.DateTime(Date.now(), false).toString$0(0);
      newCommentElement = H.interceptedTypeCheck(W._ElementFactoryProvider_createElement_tag("blockquote", null), "$isElement");
      J.set$innerHtml$x(newCommentElement, '                                <p class="mb-0">\n                                  ' + H.S(t2) + '\n                                </p>\n                                <footer class="blockquote-footer">\n                                  timestamp: ' + now + "\n                                </footer>                \n                                ");
      myCommentDivElement = t1.querySelector("#myCommentDiv");
      t1 = myCommentDivElement.childNodes;
      t2 = t1.length;
      if (0 === t2)
        myCommentDivElement.appendChild(newCommentElement);
      else {
        if (0 >= t2)
          return H.ioore(t1, 0);
        myCommentDivElement.insertBefore(newCommentElement, t1[0]);
      }
      myInput.value = "";
    }
  };
  ...
  (function installTearOffs() {
    ...
    _static_1(F, "main__onInputSubmit$closure", "onInputSubmit", 18);
  })();
  (function inheritance() {
    ...
    _inheritMany(W.HtmlElement, [W.AnchorElement, W.AreaElement, W.BaseElement, W.BodyElement, W.ButtonElement, W.FormElement, W.InputElement, W.SelectElement, W.TableElement, W.TableRowElement, W.TableSectionElement, W.TemplateElement]);
